  ...
  onAuthStateChanged(user) {
    ...
    if (user) {
      ...
      authContainer.innerHTML = `
        <div style="display:flex; align-items:center; justify-space-between; gap:0.5rem; padding:0.5rem; background:var(--bg-tertiary); border-radius:var(--radius-md); border:1px solid var(--border-color);">
          ...
          <div style="flex:1; overflow:hidden;">
            ...
            <div style="font-size:0.68rem; color:var(--text-muted);">Signed in with Google</div>
          </div>
